                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select id="my_select" class="form-control me" name="type" required>
                            ...
                            <div class="form-group" id="dinner_category">
                                ...
                                <select class="form-control me" name="dinner_start" required>
                                    ...
                                    <option value="Six Star">Six Star</option>
                                </select>
                            </div>
                                <div class="form-group">
                                ...
                                <div class="form-group" id="others_category1">
                                ...
                                <div class="form-group"  id="others_category2">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control" name="thumbnail" placeholder="Enter shop thumbnail" required>
                                </div>
