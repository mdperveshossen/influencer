                        ...
                        <div class="card-body">
                            <form action="{{ route('offer.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="heading" placeholder="Enter offer heading" required>
                                </div>
                                <div class="form-group">
                                    <label>Offer Detail</label>
                                    <textarea name="detail" rows="4" placeholder="Enter offer detail" class="form-control" required></textarea>
                                </div>
                                <div class="form-group">
                                    <label>Offer BG (640*426)</label>
                                    <input type="file" class="form-control" name="bg" required>
                                </div>
