                        ...
                        <div class="card-body">
                            <form action="{{ route('social.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="social_link" rows="4" placeholder="Enter social link" class="form-control" required></textarea>
                                </div>
                                <div class="form-group">
                                    <label>Social icon class</label>
                                    <input type="text" class="form-control" name="social_icon" placeholder="Enter social icon class"  required>
                                </div>
