...
<body data-spy="scroll" data-target="#header-navbar">
  ...
  <header class="header w-100">
    <nav class="navbar navbar-expand-lg">
      <div class="container">
        <a class="navbar-brand position-relative wow bounceInLeft" href="{{ asset('frontend_asset') }}"><img src="{{ asset('uploads/logo') }}/{{ $logo->logo }}" alt=""></a>
        ...
        <div class="col-lg-10 mx-auto wow bounceIn">
            @if (session('uer_request'))
                  ...
                  @endif
                    ...
                    @endif
          <h1 class="banner__title text-uppercase mb-5">{{ $heading->text_one }} <span class="banner__title__bold d-block">{{ $heading->text_two }}</span></h1>
  ...
  <footer class="footer wow fadeInUp overflow-hidden">
    ...
    <div class="footer__bottom col-12 text-center py-3">
      <p class="copyright mb-0">Copyright © Influencer | Designed by <a href="https://sohanthink.com/" target="_blank" class="copyright__link">sohanthink.com</a></p>
    </div>
  </footer>
