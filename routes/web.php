...
Route::get('influencer/register', 'FrontendController@influencerregister')->name('influencer.register');
...
Route::get('edit/profile', 'InfluencerController@editprofile')->name('editprofile');
Route::post('change/name', 'InfluencerController@changename')->name('changename');
Route::post('change/photo', 'InfluencerController@changephoto')->name('changephoto');
Route::post('change/password', 'InfluencerController@changepassword')->name('changepassword');
...
Route::get('home/banner/update/{id}', 'BannerController@bannertextupdate')->name('bannertextupdate');
Route::post('home/banner/update/post/{id}', 'BannerController@bannertextupdatepost')->name('bannertextupdatepost');
...
//ShopsController
Route::resource('home/register/info', 'RegisterInfoController');
...
Route::get('dashboard/influencer', 'InfluencerController@dashboardinfluencer')->name('dashboard.influencer');
