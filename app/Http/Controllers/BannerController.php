...
class BannerController extends Controller
{
    ...
    public function bannertextupdate($id)
    {
        return view('admin.banner.update_text', [
            'info' => Banner_text::find($id)
        ]);
    }
    public function bannertextupdatepost(Request $request, $id)
    {
        $request->validate([
            'text_one' => 'required',
            'text_two' => 'required'
        ]);
        Banner_text::find($id)->update($request->except('_token'));
        return back()->with('update_banner_text', 'Banner text updated successfully');
    }
}
